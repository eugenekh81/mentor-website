      ...
      <div className='container'>
        <div className='section__content'>
          ...
          <p className="section__description">
            Нижче ти можеш подивитися на деякі мої роботі. Я не викладаю всі їх тут, щоб не перевантажувати тебе інфорацією. Якщо тобі цікавий повний перелік моїх робіт - ти можеш ознайомитися з ними на моєму Гітхабі
          </p>
